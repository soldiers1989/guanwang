package com.web.common.utils.cache;
...
public class CacheUtils {
    private static StringRedisTemplate stringRedisTemplateModel;
    ...
    private void initStaticStringRedisTemplate() {
        stringRedisTemplateModel = this.stringRedisTemplate;
        redisTemplateModel = this.redisTemplate;
    }
    ...
    public static Integer getInt(String key) {
        String value = stringRedisTemplateModel.boundValueOps(key).get();
    ...
    public static String getStr(String key) {
        return stringRedisTemplateModel.boundValueOps(key).get();
    }
    ...
    public static <T> T getJson(String key, Class<T> clazz) {
        return JsonMapper.fromJsonString(stringRedisTemplateModel.boundValueOps(key).get(), clazz);
    }
    ...
    public static void set(String key, Object value, ExpireTime time) {
        if (value.getClass().equals(String.class)) {
            stringRedisTemplateModel.opsForValue().set(key, value.toString());
    ...
    public static void setJson(String key, Object value, ExpireTime time) {
        stringRedisTemplateModel.opsForValue().set(key, JsonMapper.toJsonString(value));
        if (time.getTime() > 0) {
            stringRedisTemplateModel.expire(key, time.getTime(), TimeUnit.SECONDS);
        }
    }
    ...
    public static void setJsonField(String key, String field, String value) {
        JSONObject obj = JSON.parseObject(stringRedisTemplateModel.boundValueOps(key).get());
        obj.put(field, value);
        stringRedisTemplateModel.opsForValue().set(key, obj.toJSONString());
    }
    ...
    public static void setDouble(String key, double value, ExpireTime time) {
        stringRedisTemplateModel.opsForValue().set(key, String.valueOf(value));
        if (time.getTime() > 0) {
            stringRedisTemplateModel.expire(key, time.getTime(), TimeUnit.SECONDS);
        }
    }
    ...
    public static void setIntForPhone(String key, Object value, int time) {
        stringRedisTemplateModel.opsForValue().set(key, JsonMapper.toJsonString(value));
        if (time > 0) {
            stringRedisTemplateModel.expire(key, time, TimeUnit.SECONDS);
        }
    }
    ...
    public static List<Object> lGet(String key, long start, long end) {
        try {
            return redisTemplateModel.opsForList().range(key, start, end);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static long lGetListSize(String key) {
        try {
            return redisTemplateModel.opsForList().size(key);
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public static Object lGetIndex(String key, long index) {
        try {
            return redisTemplateModel.opsForList().index(key, index);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean lSet(String key, Object value) {
        try {
            redisTemplateModel.opsForList().rightPush(key, value);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
    ...
    public static boolean lSet(String key, List<Object> value) {
        try {
            redisTemplateModel.opsForList().rightPushAll(key, value);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
    ...
    public static boolean lUpdateIndex(String key, long index, Object value) {
        try {
            redisTemplateModel.opsForList().set(key, index, value);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
    ...
    public static Long lRemove(String key, long count, Object value) {
        try {
            Long remove = redisTemplateModel.opsForList().remove(key, count, value);
            return remove;
        } catch (Exception e) {
            e.printStackTrace();
            return 0L;
