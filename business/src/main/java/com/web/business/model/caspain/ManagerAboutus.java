...
public class ManagerAboutus implements Serializable {
    private Integer id;
    ...
    public Integer getAboutusType() {
        return aboutusType;
    }

    public void setAboutusType(Integer aboutusType) {
    ...
    public String toString() {
        ...
        sb.append(", aboutusType=").append(aboutusType);
